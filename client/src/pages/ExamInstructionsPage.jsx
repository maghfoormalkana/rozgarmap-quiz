...
import { useLocation, useNavigate } from 'react-router-dom';
import { useExam } from '../hooks/useExam';
import { AlertCircle, CheckCircle2, Clock, ShieldAlert, BookOpen } from 'lucide-react';
        ...
        <div className="p-6 sm:p-10 space-y-8">
          ...
          <div>
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-4 flex items-center gap-2">
              <BookOpen className="w-5 h-5 text-rozgar-blue" />
              Exam Structure
            </h3>
            
            <div className="bg-gray-50 dark:bg-slate-700/30 rounded-xl border border-gray-200 dark:border-slate-700 overflow-hidden">
              {/* Total Summary Header */}
              <div className="p-4 bg-gray-100 dark:bg-slate-700/60 border-b border-gray-200 dark:border-slate-700 flex justify-between items-center sm:text-lg">
                <span className="font-bold text-gray-900 dark:text-white">Total Questions: 80</span>
                <span className="font-bold text-gray-900 dark:text-white">Total Marks: 80</span>
              </div>
              ...
              <div className="divide-y divide-gray-200 dark:divide-slate-700">
                ...
                {/* Section 1 */}
                <div className="p-4 sm:p-5 flex justify-between items-center hover:bg-white dark:hover:bg-slate-700/50 transition-colors">
                  <div>
                    <p className="font-bold text-gray-900 dark:text-white text-base sm:text-lg">SECTION 1: Computer Basics (MCQ)</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Each carry 1 mark</p>
                  </div>
                  <div className="text-right shrink-0">
                    <p className="font-bold text-rozgar-blue text-lg">30 Qs</p>
                    <p className="text-sm font-medium text-gray-500 dark:text-gray-400">30 Marks</p>
                  </div>
                </div>
                ...
                <div className="p-4 sm:p-5 flex justify-between items-center hover:bg-white dark:hover:bg-slate-700/50 transition-colors">
                  <div>
                    <p className="font-bold text-gray-900 dark:text-white text-base sm:text-lg">SECTION 2: General English (MCQ)</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Each carry 1 mark</p>
                  </div>
                  <div className="text-right shrink-0">
                    <p className="font-bold text-rozgar-blue text-lg">30 Qs</p>
                ...
                <div className="p-4 sm:p-5 flex justify-between items-center hover:bg-white dark:hover:bg-slate-700/50 transition-colors">
                  <div>
                    <p className="font-bold text-gray-900 dark:text-white text-base sm:text-lg">SECTION 3: General Knowledge (MCQ)</p>
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Each carry 1 mark</p>
                  </div>
                  <div className="text-right shrink-0">
                    <p className="font-bold text-rozgar-blue text-lg">20 Qs</p>
                    <p className="text-sm font-medium text-gray-500 dark:text-gray-400">20 Marks</p>
                  </div>
                </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                "You can navigate between questions using the provided 'Previous' and 'Next' buttons.",
                "You can use the Question Navigator grid to jump to specific questions.",
                "Unanswered questions will be marked as incorrect (0 marks).",
                "Your final results will not be displayed immediately; they will be sent to the administration for review."
              ].map((text, i) => (
                <li key={i} className="flex items-start gap-3">
                  <CheckCircle2 className="w-5 h-5 text-green-500 shrink-0 mt-0.5" />
