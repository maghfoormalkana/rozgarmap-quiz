...
import { RotateCcw, Home, Award, CheckCircle, XCircle } from 'lucide-react'
...
const ResultPage = () => {
  ...
  useEffect(() => {
    if (!result.studentName) { navigate('/'); return }
    saveResult()
  }, [])
      ...
      <div className="max-w-2xl mx-auto animate-slide-up">
        <div className="card p-8 mb-6">
          <div className="text-center mb-8">
            ...
            <div className="relative w-48 h-48 mx-auto mb-6">
              <svg className="w-full h-full -rotate-90" viewBox="0 0 200 200">
                ...
                <circle cx="100" cy="100" r="80" fill="none" stroke="currentColor" strokeWidth="12" strokeLinecap="round" 
                  className={result.score >= 70 ? 'text-green-500' : result.score >= 50 ? 'text-yellow-500' : 'text-red-500'} 
                  strokeDasharray={circleProgress} strokeDashoffset={strokeDashoffset} 
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <button 
              onClick={() => { sessionStorage.removeItem('quizResult'); sessionStorage.removeItem('quizSetup'); navigate('/quiz-setup') }} 
